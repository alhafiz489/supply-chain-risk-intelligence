...
<head>
    <meta charset="UTF-8">
    <title>{{ app()->getLocale() === 'id' ? 'Tambah Kata Sentimen - SupplyGuard' : 'Add Sentiment Word - SupplyGuard' }}</title>
...
<header class="topbar">
    ...
    <main class="page-wrapper">
        <section>
            <h1 class="page-title">
                {{ app()->getLocale() === 'id' ? 'Tambah Kata Sentimen' : 'Add Sentiment Word' }}
            </h1>
            ...
            <form method="POST" action="{{ route('admin.sentiment-words.store') }}">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <select
                            ...
                            required
                        >
                            <option value="positive" @selected(old('type', 'positive') === 'positive')>
                                {{ app()->getLocale() === 'id' ? 'Positif' : 'Positive' }}
                            </option>
                            <option value="negative" @selected(old('type', 'positive') === 'negative')>
                ...
                <div class="button-wrapper">
                    ...
                    <button type="submit" class="btn btn-primary form-action-button">
                        {{ app()->getLocale() === 'id' ? 'Simpan Kata' : 'Save Word' }}
                    </button>
                </div>
            </form>
        </section>
